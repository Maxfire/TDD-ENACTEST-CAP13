...
test('getChange(275, 500) should return [200, 20, 5]', function(assert) {
  var result = getChange(275, 500); // expect an array containing [200, 20, 5]
  var expected = [200, 20, 5];
  assert.deepEqual(result, expected);
});

test('getChange(99, 200) should return [100, 1]', function(assert) {
  var result = getChange(99, 200);
  var expected = [100, 1];
  assert.deepEqual(result, expected);
});

test('getChange(50, 100) should return [50]', function(assert) {
  var result = getChange(50, 100);
  var expected = [50];
  assert.deepEqual(result, expected);
});
